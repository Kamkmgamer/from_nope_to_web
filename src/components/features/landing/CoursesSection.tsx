  ...
  const courses = [
    {
      ...
      topics: ["HTML5", "CSS3", "Semantic HTML", "Flexbox & Grid"],
    ...
    },
    {
      ...
      topics: ["ES6+", "Async/Await", "DOM Manipulation", "Event Loop"],
      level: t("levels.beginner"),
    },
    {
      number: "III",
      ...
      topics: ["React 19", "Next.js 15", "Server Components", "Tailwind"],
    ...
    },
    {
      ...
      topics: ["Type Safety", "tRPC", "Drizzle ORM", "Auth"],
